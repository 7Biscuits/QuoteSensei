const Navbar = ({ fetchQuote }) => {
    return (
        <nav class="bg-transparent border border-gray-100 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="/logo.jpeg" class="h-8 mr-3 rounded-full" alt="Flowbite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">QuoteSensei</span>
                </a>
